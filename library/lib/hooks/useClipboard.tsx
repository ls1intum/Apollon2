...
export const useClipboard = () => {
  ...
  const readFromClipboard = useCallback(async (): Promise<ClipboardData | null> => {
    try {
      let text: string
      ...
      if (data && Array.isArray(data.nodes) && Array.isArray(data.edges) && typeof data.timestamp === 'number') {
        return data
      }
