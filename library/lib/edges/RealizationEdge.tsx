...
//           Wrap it in a div with a ref to detect outside clicks. */}
//       {toolbarOpen && (
...
import {TRIANGLE_MARKER_PADDING} from "@/constants";
import { GenericEdge } from "./GenericEdge";
import { CustomEdgeProps } from "./EdgeProps";
export const RealizationEdge = (props: EdgeProps<Edge<CustomEdgeProps>>) => {
  return (
    <GenericEdge
      {...props}
