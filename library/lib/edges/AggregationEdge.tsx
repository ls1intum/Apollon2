...
//   const { roleX: sourceRoleX, roleY: sourceRoleY, multiplicityX: sourceMultiplicityX, multiplicityY: sourceMultiplicityY } =
//   calculateEdgeLabels(sourceX, sourceY, sourcePosition);

// const { roleX: targetRoleX, roleY: targetRoleY, multiplicityX: targetMultiplicityX, multiplicityY: targetMultiplicityY } =
...
export const AggregationEdge = (props: EdgeProps<Edge<CustomEdgeProps>>) => {
  return (
    <GenericEdge
      {...props}
      markerEnd="url(#white-rhombus)"
